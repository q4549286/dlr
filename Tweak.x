...
static void (^g_s1_completion_handler)(NSString *result) = nil; // S1回调
static NSString *g_s1_keTiResult_forPowerMode = nil; // 深度解构临时变量
static NSString *g_s1_jiuZongMenResult_forPowerMode = nil; // 深度解构临时变量
