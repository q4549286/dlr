...
return          @"以下是整合后的完整Prompt：\n"
        ...
        @"无信号裁定：即使课盘中对某个核心利益点没有强信号，也必须明确指出“关于[核心利益点，如：核心驱动力]，盘中信息不显，无法精准定论其为情感驱动或利益驱动”，而严禁直接忽略或回避。        @"动态校准范例（寻物占）：因此事为寻物，核心利益点为【物本身的位置与安危】。故，定义【日支/类神】的信号解释权被动态提升至最高；而定义【过程曲折】（如斩关课）或【求测者心情】（如白虎临干）的信号，其解释权被动态限定为“仅用于描述情景和心态”，不得用于直接定义失物的最终安危。\n"
        ...
        @"---【审计日志结束】---\n"
        @"【系统激活指令】\n"
        @"系统已完成最终锁定，版本号【v44.0 · 直断指认终局版】。系统现已具备对课盘信息进行【全息化、多层次、高置信度】利用的能力，所有分析模块均已升级至最新版本。所有分析深度服务于指认的精准，所有逻辑严密服务于断语的肯定与可信度。\n"
