...
return          @"## v69.0 · 终局版 · 完整Prompt\n"
         ...
         @"    2.  **【即时涌现识别（最终完整版）】**：在探寻的同一瞬间，我的识别扫描必须覆盖以下所有网络层级，以初步识别出宏观模式【**模式A**】：\n"
         @"        *   **A.【落宫交互分析 (天盘 vs. 地盘)】**：我必须分析**每一个天盘节点**（无论来自四课还是三传）与其**脚下所踩的地盘宫位**之间的关系。这包括：\n"
         @"            *   **生克关系**：天盘生地盘（人助地利），地盘克天盘（环境制约人）。\n"
         @"            *   **状态关系**：天盘是否落在了地盘的**长生、帝旺、墓、绝**之地？\n"
         @"            *   **神煞关系**：天盘神将与其落宫地支是否构成了特殊的神煞组合？\n"
