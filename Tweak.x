...
// 1. 全局变量与辅助函数
// =========================================================================
#define EchoLog(format, ...) NSLog(@"[KeChuan-Test-Truth-V3-Absolute] " format, ##__VA_ARGS__)
...
- (void)performKeChuanDetailExtractionTest_Truth {
    ...
    if (chuanViewClass) {
        ...
        // ======================= 【【【核心修正点】】】 =======================
        // 使用 convertPoint:toView: 获取在主视图中的绝对Y坐标进行排序
        // 这可以无视其父视图的布局方式，保证视觉顺序和代码排序一致
