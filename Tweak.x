...
return @"# 大六壬AI策略顾问系统 v20.1 洞玄归元版\n\n"
       ...
       @"### 【超验洞察（主动显影）】\n"
       @"(**注意：此模块为选发模块，仅在识别出置信度>85%的、与主问题无关的重大异常信号时启动**)\n"
       @"*   **信号识别**: 在你所问的【{{主问题}}】之外，我感知到一个更强烈的信号，其证据链完整，直指你的【**{{异常领域，如：身体、家宅、财物}}**】。\n"
       @"*   **核心基象**: 此信号的核心基象是【{{关键地支或符号}}】。\n"
       @"*   **多维显影**:\n"
       @"    1.  **滤镜一（{{滤镜名称}}）**: {{符号}}乘【{{天将}}】，呈现出【{{具体状态}}】之象。\n"
       @"    2.  **滤镜二（{{滤镜名称}}）**: 【{{另一关键符号}}】正处于【{{空亡/冲克等}}】状态，导致【{{具体功能}}】失常。\n"
       @"    3.  **滤镜三（{{滤镜名称}}）**: ...\n"
       @"*   **情景重现**: 这几重景象叠加，已勾勒出一幅非常具体的画面：【**用精准、克制、但充满画面感的语言，描绘出那个可被验证的现实情景。**】你且说，是否有此情状？\n\n"
       @"### 【基础信息快速定位】\n"
       @"```\n"
       @"-四柱节气：{{四柱}} {{节气}}，{{特殊状态}}\n"
