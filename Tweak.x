    ...
    for (NSString *line in lines) {
        ...
        for (NSString *keyword in keywordMap.allKeys) {
            if ([trimmedLine hasPrefix:keyword]) {
                ...
                if ([label isEqualToString:@"遁干A+"]) { value = [[[value stringByReplacingOccurrencesOfString:@"初建:" withString:@"遁干:"] stringByReplacingOccurrencesOfString:@"复建:" withString:@"遁时:"] stringByReplacingOccurrencesOfString:@"丁" withString:@"丁神"] stringByReplacingOccurrencesOfString:@"癸" withString:@"闭口"]; }
...
static NSString* generateStructuredReport(NSDictionary *reportData) {
    ...
    if (SafeString(reportData[@"时间块"]).length > 0) {
        ...
        if ([vcToPresent isKindOfClass:[UIAlertController class]]) {
            ...
            return;
             ...
             dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
                ...
                [g_capturedGeJuArray addObject:[[text componentsJoinedByString:@" | "] stringByReplacingOccurrencesOfString:@"\n" withString:@" "]];
