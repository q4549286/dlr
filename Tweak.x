...
// ... (viewDidLoad, createOrShowMainControlPanel, handleMasterButtonTap, presentAIActionSheetWithReport 保持不变, 但 handleMasterButtonTap 调用新函数) ...
