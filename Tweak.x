...
return         @"【大六壬AI策略顾问系统 v22.0 涅槃重生版 · 完整展开】\n"
        ...
        @"执行: 在分析之初，你必须首先扫描是否存在此法则的强力信号。若存在，必须将其作为【最高变量】，并以此为基调来审视整个课盘。若【年命】信息明确存在: 你必须启动此法则，将其作为【最高变量】，并以此为基调来审视整个课盘。若【年命】信息缺失: 你必须在【法则博弈初判】环节明确报告：“天命法则扫描：因求测者未提供年命信息，此最高序位法则本次不参与裁决。” 然后，你必须完全跳过此法则的后续分析，直接进入第二序位法则的评估。严禁对此进行任何猜测或假设。\n"
        @"【第二序位：力量状态法则（现实强弱对比）】:\n"
