...
// --- createOrShowControlPanel_Truth & copyAndClose_Truth (无变化) ---
%new
- (void)createOrShowControlPanel_Truth { /* UI代码与之前相同 */ }
%new
- (void)copyAndClose_Truth { /* 复制粘贴代码与之前相同 */ }
