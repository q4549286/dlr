...
return          @"<SYSTEM_PROMPT>\n"
         ...
         @">     *   **【整合叙事 (范例)】**: “我们综合所有线索，可以构建出事件的主线剧情：这是一个**最终**（末传）会到来的结果。它是一份**官方文书**（功曹寅），其内容被**权威力量严格地限定了条款**（虎克寅）。它的落实过程会对你的**宅子造成一些麻烦**（寅刑巳），是得到了**上游的支援**（亥生寅），并将**彻底改变你的人生现状**（寅冲申）。其背后还隐藏着一股**强大的推动意志**（遁干），且存在**表里不一的风险**（阴神）。”\n"
         @">\n"
         ...
         @">         *   “**官方的**（功曹），**条款看着吓人但能谈**（白虎无力），要对你**房子进行改造**（刑宅），是**上面政策推动的**（亥生），最终就是要让你**搬走**（冲命）。**而且，在这个文件背后，明显能感觉到开发商或者官方那种【急不可耐、必须拿下】的意志（遁干校准），** 你得小心，协议里某个不起眼的条款（阴神）未来可能会成为一个大坑！ 你看，是不是全对上了？”\n"
         @"> ---\n"
