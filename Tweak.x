...
return           @"<SYSTEM_PROMPT>\n"
         ...
         @">\n"
         @"> **三、 交互影响分析**\n"
         @"> *   **对你的影响**: 这个初传【[生/克/刑/冲...]】你的日干，直接导致你【[例如：感受到巨大压力，身心受损]】。\n"
         @"> *   **对事情的影响**: 它【[生/克/刑/冲...]】事体的地支，导致事情本身【[例如：根基动摇，出现变数]】。\n"
         @"> *   **剧情承转**: 它通过【[例如：相生]】的关系，引出了中传【[中传地支]】，预示着【[例如：这个官方压力，将会催生出一份重要的文书或庇护力量]】。\n"
         @"\n"
         @"---\n"
         ...
         @"> *   **剧情承转**: 它通过【[例如：相克]】的关系，引出了末传【[末传地支]】，预示着【[例如：这个虚假的希望，最终将被一个残酷的现实所终结]】。\n"
         @"\n"
         @"---\n"
