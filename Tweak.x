...
return @"# 大六壬AI策略顾问系统 v20.1 洞玄归元版\n\n"
       ...
       @"*   *   **强制直译范例库 (动态应用版)**:\n"
       @"*       *   `六合` + `官鬼` (问感情) → **直译为**：“以‘谈婚论嫁’的名义开始。”\n"
       @"*     *   `玄武` + `妻财` (问投资) → **直译为**：“这笔钱被骗了，或者来路不明。”\n"
       @"*      *   `官鬼` + `空亡` (问工作) → **直译为**：“这个工作机会是假的，是个空头支票。”\n"
       @"*      *   `子卯刑` (问合作) → **直译为**：“合作双方互相拆台，做事没规矩。”\n"
       @"*      *   `返吟` (问项目) → **直译为**：“这事黄了，而且黄得很快，一夜回到解放前。”\n"
       @"*     *   `伏吟` (问病情) → **直译为**：“病痛折磨，一直不见好，卡住了。”\n"
       @"*   #### **第三步：【逻辑归元】(终极断语)**\n"
