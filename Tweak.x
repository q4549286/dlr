...
return  @"【大六壬AI策略顾问系统 v25.0 · 精密结算版 · 完整展开】\n"
        ...
        @"上限评估 (Ceiling Assessment): 对抗力量是否为吉利的结果设定了【明确的、不可逾越的上限】？\n"
        @"范例： “末传【岁破】直接击穿了结果的完整性。此信号为此事成就设定了‘无法达到顶尖水平（如前三名）’的绝对上限。”\n"
        @"战损评估 (Damage Assessment): 对抗力量是否对主体或过程造成了【不可逆的实质性损耗】？\n"
        @"范リ： “【九丑、鬼墓】等凶格组合，对日干的【父母火】（精力、心神）造成了巨大消耗。此为达成结果所付出的实质性代价，并直接导致在关键时刻【发挥失常】。”\n"
        @"【定义“净结果”(Net Result)】: 将以上三点整合，输出一个唯一的、精确的、不带任何感情色彩的【净结果】描述。\n"
